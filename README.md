...
- The api is consumed by this [React project](https://github.com/Zuwairanajma/hello-react-front-end.git)
...
```
  ...
  git clone https://github.com/Zuwairanajma/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/Zuwairanajma/hello-rails-back-end/issues).
